...
import {TaskStatus, TaskType} from "../../components/task-card/model/types/task-schema";
import {moveTaskOnTheTable, setNewTaskStatus} from "../../components/task-table/model/slice/task-table-actions";
