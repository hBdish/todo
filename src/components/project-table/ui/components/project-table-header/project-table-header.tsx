...
const ProjectTableHeader = (props: ProjectTableHeaderProps) => {
  ...
  return (
    <Table.Row className={classNames(styles.tableRowHead, {}, [className])}>
      <Table.HeaderCell className={styles.tableCellHead}><Text title={"Имя"}/></Table.HeaderCell>
      <Table.HeaderCell className={styles.tableCellHead}><Text title={"Тип"}/></Table.HeaderCell>
